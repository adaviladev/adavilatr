...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function displayPost(index) {
      ...
      article.classList.add('mb-4', 'p-3', 'bg-white', 'rounded', 'shadow-sm');
      article.innerHTML = `
          <h3>${post.title}</h3>
